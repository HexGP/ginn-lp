...
# 4. Conservative model architecture
print("\n=== MODEL ARCHITECTURE ===")
input_size = 6
num_outputs = 2

# Conservative architecture - similar to original but with more output-specific blocks
ln_blocks = (3, 3)          # 2 shared layers, same as original
lin_blocks = (3, 3)         # Must match ln_blocks
output_ln_blocks = 6        # More output-specific complexity than original
...
model = eql_model_v3_multioutput(
    ...
    l1_reg=1e-4,   # Conservative L1 regularization
    l2_reg=1e-4    # Conservative L2 regularization
)
...
print("- Conservative regularization to avoid NaN")
