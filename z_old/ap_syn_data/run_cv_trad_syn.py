...
# =============== USER CONFIG ===============
DATA_CSV = "data/syn_reg.csv"   # SYN dataset for traditional approach
...
def get_output_filename(dataset_path):
    ...
    return f"outputs/JSON_SYN/trad_{first_three}_{num_layers}S_{blocks_per_layer}B_{output_blocks}L.json"
