...
from linear_regressor.linear_regressor import MultiTaskLinearRegression
from gp_regressor.gp_regressor import MultiTaskGaussianProcess
from mlp_regressor.mlp_regressor import MLPRegressionModel
from multiout_regressor.multiout_regressor import MultiOutputRegressionModel
from sgd_regressor.sgd_regressor import MultiTaskSGDRegressor
...
def main():
    ...
    output_file = os.path.join(script_dir, 'model_comparison_results.csv')
    ...
    detailed_output_file = os.path.join(script_dir, 'detailed_model_comparison_results.csv')
